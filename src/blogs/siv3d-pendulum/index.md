...
　こうしてできたものがこちらになります。  
　![単振り子シミュレーション](./0010.gif){eleventy:ignore loading="lazy" decoding="async"}
...
　![二重振り子シミュレーション](./0020.gif){eleventy:ignore loading="lazy" decoding="async"}
...
　![僅差二重振り子](./0030.gif){eleventy:ignore loading="lazy" decoding="async"}
